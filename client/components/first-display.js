...
const First = () => {
  return (
    <div>
      <p className="flex justify-center text-2xl px-32 text-center">Свадьба Амира и Анны</p>
      <hr className="gradient" />
      <nav className="bg-white px-8 pt-2">
        <div className="flex justify-center">
          <a
            className="no-underline text-grey-dark uppercase tracking-wide font-normal text-2xl text-base py-3 mr-8"
            href="#invitation"
          >
            Главное
          </a>
